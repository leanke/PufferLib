...
typedef enum {
    ...
    // Boss + Hardmode-tier gear
    ITEM_BOSS_SUMMON, ITEM_BOSS_SOUL,
    ITEM_PICK_COBALT, ITEM_AXE_COBALT, ITEM_SWORD_COBALT,
    ITEM_HELM_COBALT, ITEM_CHEST_COBALT, ITEM_LEGS_COBALT,
    // Silver tier (pre-Hardmode, between Iron and Gold)
    ITEM_SILVER_ORE, ITEM_SILVER_BAR,
    ITEM_PICK_SILVER, ITEM_AXE_SILVER, ITEM_SWORD_SILVER,
    ITEM_HELM_SILVER, ITEM_CHEST_SILVER, ITEM_LEGS_SILVER,
    // Merchant economy
    ITEM_COIN, ITEM_HEALTH_POTION,
    // Accessories
    ITEM_ACC_BOOTS, ITEM_ACC_RING,
    ITEM_COUNT
} ItemType;
